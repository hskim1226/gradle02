...
public class AdminAuthenticationFailureHandler implements org.springframework.security.web.authentication.AuthenticationFailureHandler {
	
    static final Logger logger = LoggerFactory.getLogger(AdminAuthenticationFailureHandler.class);

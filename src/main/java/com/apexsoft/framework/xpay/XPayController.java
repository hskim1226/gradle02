...
public class XPayController {
    ...
    public String confirmPayment( HttpServletRequest request ) throws NoSuchAlgorithmException {
    ...
    public String processXPay(HttpServletRequest request) throws NoSuchAlgorithmException {

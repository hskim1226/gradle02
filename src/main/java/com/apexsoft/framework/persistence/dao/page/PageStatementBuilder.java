...
public class PageStatementBuilder {
	...
	public static PageStatement buildStatement(final String totalCountStatementId, final String dataStatementId) {
		return new PageStatement() {
			 ...
			 * 
			 * @see
			 * com.apexsoft.framework.core.persistence.dao.page.PageStatement#getTotalCountStatementId()
			 */
			@Override
			 ...
			 * (non-Javadoc)
			 * 
			 * @see com.apexsoft.framework.core.persistence.dao.page.PageStatement#getDataStatementId()
			 */
			@Override

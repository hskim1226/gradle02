...
public class ApplSlipConsumer extends AbstractS3Consumer {
    ...
    public ApplSlipConsumer(String midPath,
                            int fileCount,
                            String backupDir) {
    ...
    protected String getFilePath(BackUpApplDoc backUpApplDoc) {
        String uploadDirFullPath = FilePathUtil.getUploadDirectoryFullPath(baseDir, midPath, backUpApplDoc.getAdmsNo(), backUpApplDoc.getUserId(), backUpApplDoc.getApplNo());

                ...
                <div class="form-group inner-container-white">
                        ...
                        <div class="col-sm-offset-1 col-sm-10">
                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-12 nopadding">
                                    <form:input path="name" cssClass="form-control input-text" maxlength="20" placeholder="${msg.getMsg('U00201')}" /> <%--이름--%>
                                </div>
                    ...
                    <div class="form-group required">
                        <div class="col-sm-offset-1 col-sm-10">
                            ...
                            <div class="col-sm-9">
                                <div class="col-sm-12 nopadding">
                                    <form:input path="mailAddr" cssClass="form-control input-text" maxlength="50" placeholder="${msg.getMsg('U00202')}" />  <%--이메일을 입력해 주세요--%>
                                </div>

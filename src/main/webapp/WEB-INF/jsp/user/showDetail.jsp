...
<html lang='ko'>
<head>
    <title><spring:message code="L00171"/><%--회원 정보--%></title>
            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="form-group inner-container-white">
                    <div class="col-sm-offset-1 col-sm-10 text-gray">
                        <i class="fa fa-user fa-3x" style="vertical-align: middle; line-height:40px;"></i>&nbsp;&nbsp;<span style="font-size: 35px; vertical-align: middle; line-height:40px;"><b><spring:message code="L00171"/><%--회원 정보--%></b></span>
                    </div>
                        ...
                        <div class="col-sm-offset-2 col-sm-8">
                            <div class="col-sm-12 btn-group btn-group-justified">
                                <div class="btn-group col-sm-6">
                                    <button id="modify" class="btn btn-primary btn-lg"><spring:message code="L00172"/><%--회원 정보 수정--%></button>
                                </div>
                                <div class="btn-group col-sm-6">
                                    <button id="change-pwd" class="btn btn-info btn-lg"><spring:message code="L00173"/><%--비밀 번호 변경--%></button>
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <div>
                <div>
                    <form id="idSearchForm" action="${contextPath}/admin/search/applicants/idSearch'" method="post">
                        ...
                        <input id="idSearchBtn" type='image' class="Limage" src="<spring:eval expression="@app.getProperty(\"path.static\")"/>/img/admin/repository/btn_search.gif" />
                    </form>
                </div>
				<div>
                    <form id="nameSearchForm" action=${contextPath}/admin/search/applicants/nameSearch  method="post">
                        ...
                        <input id="nameSearchBtn" type='image' class="Limage" src="<spring:eval expression="@app.getProperty(\"path.static\")"/>/img/admin/repository/btn_search.gif" />
                    </form>
                </div>                     
              <div>

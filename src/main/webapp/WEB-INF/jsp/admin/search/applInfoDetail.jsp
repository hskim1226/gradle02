...
<div class="content">
    ...
    <div class="con_section">
        ...
        <form id= "searchForm" method="post">
            <input type="hidden" id='applNo' name="applNo" value="${applInfo.applNo}" />
            <input type="hidden" id="userId" name="userId" value="${applInfo.userId}" />
            <input type="hidden" id="admsNo" name="admsNo" value="${applInfo.admsNo}" />
        </form>

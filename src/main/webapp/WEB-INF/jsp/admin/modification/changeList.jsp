            ...
            <ul>
                ...
                <c:if test="${indexCount != 0}">
                    ...
                    <c:if test="${changeSearchPageForm.page.no-1 > 0}">
                        <li class="Lprevious"><span><a href="#" onclick="movePage(${changeSearchPageForm.page.no-1}); return false;"><img src="${contextPath}/img/admin/repository/list_page_previous.gif" alt="이전페이지" /></a></span></li>
                    </c:if>
                    ...
                    <c:if test="${changeSearchPageForm.page.no < indexCount}">
                        <li class="Lnext"><span><a href="#" onclick="movePage(${changeSearchPageForm.page.no+1}); return false;"><img src="${contextPath}/img/admin/repository/list_page_next.gif" alt="다음페이지" /></a></span></li>
                    </c:if>

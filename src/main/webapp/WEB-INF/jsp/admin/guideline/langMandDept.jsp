...
<div id="LblockMain">
    <div id="LblockPageTitle">
        <div id="LblockPageLocation">
            <ul>
                ...
                <li><span><a href="#">기준정보관리</a></span></li>
                <li class="Llast"><span>학과별 어학 요건</span></li>
            </ul>
        </div>
    ...
    <div id="LblockMainBody" >
              ...
              <div>
                    <form id="deptSearchForm" action=${contextPath}/admin/search/applicants/deptSearch  method="post">
                        ...
                        <table summary="학과별  검색조건">
                            ...
                            <tbody>
                            <tr><th class="Cat">모집단위 검색 : </th>
                                <th><label for="admsNo">모집전형</label></th>
                                <td>
        ...
        <div id="LblockListTable01" class="LblockListTable">
            <table summary="학과별 어학 설정현황" >
                <caption>어학 설정 현황</caption>
                <thead>
                <tr>
                    <th class="Lfirst">전형</th>
                    <th>캠퍼스</th>
                    <th>대학</th>
                    <th>학과</th>
                    <th>학생정보</th>

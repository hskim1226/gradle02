    ...
    <div id="modal_popup3" class="popup1_wrap" style="display:none; margin-top:-250px; margin-left:-250px;">
        ...
        <div class="popupbody" style="display:${pageContext.response.locale == 'en' ?'none':'visible'}">
            <h4><strong>
                ...
                <span style="font-weight: 900; color: red; font-size: 25px;">현재 입금자가 폭주하여 입금 확인이 지연되고 있습니다.<br/>입금 확인이 지연되더라도, 16:30 전까지 입금을 완료하신 신청건은 모두 유효한 신청으로 완료된 것이므로<br/>별도의 연락이 없더라도 걱정하지 않으셔도 됩니다.</span>
            </strong></h4>
        </div>

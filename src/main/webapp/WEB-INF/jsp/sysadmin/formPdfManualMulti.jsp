            ...
            <div class="col-md-offset-2 col-md-8">
                <div class="inner-container-white">
                    ...
                    <div class="form-group required col-sm-12">
                        <div class="col-sm-offset-1 col-sm-10">
                            <div class="col-sm-3 text-gray">
                                <label for="applNoList" class="control-label"> APPL_NO : </label>
                            </div>
                            <div class="col-sm-9">
                                <input type="text" id="applNoList" name="noList" class="form-control input-text" placeholder="APPL_NO를 쉼표로 분리해서 입력해주세요."/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-12">
                        <div class="col-sm-offset-1 col-sm-10">
                            <div class="col-sm-12">
                                <button class="btn btn-primary btn-lg btn-block btn-save input-text" id="processPDF"> 최종 PDF 재생성 및 S3 업로드 </button>
                            </div>
                        </div>
                    </div>
                    <div class="spacer-tiny">&nbsp;</div>
    ...
    <script type="text/javascript">
        $(document).ready( function() {
            ...
            $('#processPDF').click( function(e) {
                ...
                form.action = "${contextPath}/sysadmin/pdf-manual-multi";
                form.submit();
            });

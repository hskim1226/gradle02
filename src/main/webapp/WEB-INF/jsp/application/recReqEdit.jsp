        ...
        <%--<form id="reqRec" class="form-horizontal">--%>
            <div class="col-md-offset-1 col-md-10">
                <div class="form-group inner-container-white">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10 text-gray">
                            <div class="col-sm-12 text-left small"><spring:message code="U06514"/><%--추천서 진행 상태는 '내 원서 > 추천서 요청' 화면에서 확인할 수 있습니다.--%></div>
                            <div class="col-sm-12 text-left small"><spring:message code="U06515" arguments="<span class='text-danger'>${dueDate}</span>,${dueDateKorea}"/><%--추천서는 {0} 까지 제출되어야 합니다.--%></div>
                            <div class="col-sm-12 text-left small"><spring:message code="U06516"/><%--추천서 진행 상태는 '내 원서 > 추천서 요청' 화면에서 확인할 수 있습니다.--%></div>
                            <div class="col-sm-12 text-left small"><spring:message code="U06517"/><%--GRADNET에서는 추천서 등록 마감일까지 완료되지 않은 요청건에 대해 메일을 재발송하여 추천인에게 알립니다.--%></div>
                            <div class="col-sm-12 text-left small"><spring:message code="U06518"/><%--GRADNET은 마감일까지 등록되지 않은 추천서에 대해 책임을 지지 않습니다.--%></div>
                            <div class="col-sm-12 text-left small"><spring:message code="U06519"/><%--지원자께서도 마감일까지 추천서가 등록되도록 추천인에게 개별적으로 연락하시길 부탁드립니다.--%></div>
                            <div class="col-sm-12 text-left small"><spring:message code="U06520"/><%--지원자께서도 마감일까지 추천서가 등록되도록 추천인에게 개별적으로 연락하시길 부탁드립니다.--%></div>
                        </div>
                    </div>
                    <div class="spacer-tiny">&nbsp;</div>
                    <div class="col-sm-offset-1 col-sm-10">
                        ...
                        <%--</div>--%>
                        <div class="col-sm-4">
                            <button id="save" class="save btn btn-success btn-lg btn-block btn-save input-text"><spring:message code="L06532"/><%--임시 저장--%></button>
                        </div>
                        <div class="col-sm-4">
                            <button id="delete" class="cancel btn btn-danger btn-lg btn-block btn-save input-text"><spring:message code="L06535"/><%--취소--%></button>
                        </div>
                        <div class="col-sm-4">
                            <button id="send" class="send btn btn-primary btn-lg btn-block btn-save input-text"><spring:message code="L06533"/><%--추천서 요청 메일 보내기--%></button>
                        </div>
                    </div>
                </div>
            </div>

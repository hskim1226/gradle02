            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="inner-container-white">
                    <div class="col-sm-offset-1 col-sm-10 text-gray">
                        <i class="fa fa-info-circle fa-3x" style="vertical-align: middle; line-height:40px;"></i>&nbsp;&nbsp;<span style="font-size: 35px; vertical-align: middle; line-height:40px;"><b>일반 전형</b></span>
                    </div>

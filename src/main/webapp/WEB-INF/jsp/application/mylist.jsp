                ...
                <div class="align-center">
                    <form class="form-horizontal" id="LGD_PAYINFO" role="form" action="${contextPath}/pay/confirm" method="post">
                        <table class="table table-stripped">
                            ...
                            <tr>
                                <td>일반</td>
                                <td>${application.campName}</td>
                                <td>${application.admsDesc}</td>
                                <td>${application.collName}</td>
                                <td>${application.deptName}</td>
                                <td>${application.detlMajName}</td>
                                <td>${application.applStsCode}</td>
                            </tr>
                            </c:forEach>
                            </tbody>
                        </table>

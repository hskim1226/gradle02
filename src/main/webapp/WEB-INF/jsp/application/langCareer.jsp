...
<c:if test="${isSYSADMIN}">
    <div>
        <span style="position: fixed; z-index: 900; text-align: center;" class="btn-group-justified btn-lg btn-danger">THIS IS SYSADMIN, Real USER_ID : ${langCareer.application.userId}</span>
    </div>
</c:if>

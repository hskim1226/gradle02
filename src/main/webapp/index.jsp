    ...
    <section class="slice">
        <div class="container">
            <div class="row">
                ...
                <div><span style="font-weight: 900; color: red; font-size: 25px;">현재 입금자가 폭주하여 입금 확인이 지연되고 있습니다.<br/>입금 확인이 지연되더라도, 시스템에서 원서를 제출하시고 16:30 전까지 입금을 완료하신 신청건은 모두 유효한 신청으로 완료된 것이므로<br/>별도의 연락이 없더라도 걱정하지 않으셔도 됩니다.</span></div>

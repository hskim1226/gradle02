...
dui.effect.Scale.prototype = {
	...
	change : function(pe) {
		if (this.eventCnt > this.eventNum) {
			...
			if (this.nodisplay) {
				if (this.arrayW[this.eventCnt] == 0 || this.arrayH[this.eventCnt] == 0) this.el.style.display = "none";
				else 	if (this.el.getStyle("display") == "none") this.el.style.display = "block";
			}
